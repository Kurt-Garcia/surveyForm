...
<!-- Reset Password Section with same background as welcome -->
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                ...
                <div class="glass-card">
                    <div class="glass-header text-center mb-4">
                        ...
                        <p class="text-light opacity-75">Create a new secure password</p>
                    </div>

                    <form method="POST" action="{{ route('password.update') }}" class="glass-form">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="password" class="glass-label">{{ __('New Password') }}</label>
                        ...
                        <div class="mb-4">
                            <label for="password-confirm" class="glass-label">{{ __('Confirm Password') }}</label>
                            <div class="glass-input-group password-wrapper">
                                <i class="bi bi-lock input-icon password-icon"></i>
                                <div class="password-input-group w-100">
                                    <input id="password-confirm" type="password" class="glass-input" 
                                        name="password_confirmation" required autocomplete="new-password"
                                        placeholder="Confirm new password">
                                    <button type="button" class="glass-password-toggle" data-target="password-confirm">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
                            </div>
