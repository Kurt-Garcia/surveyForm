    ...
    <div class="mb-3 d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-2 gap-sm-0">
        ...
        <div class="wrapper">
            <a href="{{ Auth::guard('admin')->check() ? route('admin.surveys.responses.index', $survey) : route('surveys.responses.index', $survey) }}" class="cta">
                <span>BACK</span>
                <span>
                    <svg width="44px" height="28px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="scale(-1, 1) translate(-66, 0)">
...
.cta {
    ...
    transition: 1s;
    box-shadow: 3px 3px 0 var(--secondary-color, #6c757d);
...
.cta:hover {
    transition: 0.5s;
    box-shadow: 5px 5px 0 var(--secondary-color, #6c757d);
    color: white;
    text-decoration: none;
...
@media (max-width: 768px) {
    ...
    .cta:hover {
        box-shadow: 4px 4px 0 var(--secondary-color, #6c757d);
    }
}
...
@media (max-width: 576px) {
    .cta {
        font-size: 10px;
        padding: 4px 12px;
        box-shadow: 2px 2px 0 var(--secondary-color, #6c757d);
        min-height: 28px;
    }
